exports.getTemplate = (email, username, userId) => {
  return `
  ...
  @media only screen and (max-width:480px) {
    ...
    <img
       alt="" height="auto" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPRjuDXF_ZZ44kbpF3CujmuF5PE3twKiE_2w&usqp=CAU" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="600"
    />
    ...
    ><span style="color:#FEEB35">Dear ${username}</span><br /><br /> Welcome to Moving Out.</div>
    ...
    >We&apos;re really excited you&apos;ve decided to give us a try. In case you have any questions, feel free to reach out to us at <a style="color:white; font-weight: bold" href="mailto:support@movingout.com">Moving Out Support</a>.
</br>
</br>
You can login to your account with your email <a style="color:white; font-weight: bold">${email}</a></div>
    ...
    >
      <tr>
        ...
        >
          ...
          >
            <a href="https://movingout88.herokuapp.com/activate/${userId}" style="text-decoration:none; color:#1AA0E1">Activate</a>
          </p>
        </td>
      </tr>
    </table>
    ...
    <div
       style="font-family:open Sans Helvetica, Arial, sans-serif;font-size:15px;line-height:1;text-align:left;color:#ffffff;"
    >Thanks, <br /> The Moving Out Team</div>
